<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modificar.aspx.cs" Inherits="libreriaOnline.Modificar" %>
                    ...
                    <tr>
                        <td style="width: 50%; padding-right: 5px; padding-left: 5px; padding: 20px; border: 1px solid black" valign="top">
                            ...
                            <div style="background-color: #2492fc; width: 200px; margin: 0 auto; padding: 10px; color: white; border-radius: 8px 8px 8px 8px; -webkit-border-radius: 8px 8px 8px 8px; margin-top: 20px; cursor: pointer; height: 50px; text-align: center;">
                                <asp:LinkButton ID="lnkmodificarEscritor" runat="server" OnClick="lnkmodificarEscritor_Click">
                                ...
                                <table style="width: 100%;">
                                    <tr>
                                        ...
                                        <td style="width: 50%;">
                                            ...
                                            <div style="width: 100%;">
                                                <asp:DropDownList ID="ddlEscritoresNew" runat="server"></asp:DropDownList>
                                            </div>
                                            <br />
                                            <br />
                                            <div style="width: 100%;">
